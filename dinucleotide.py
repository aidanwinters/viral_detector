...
class dinucleotide(object):
	...
	def global_counts_freqs(self):
		...
		self.global_nuc_freqs,self.global_di_freqs = dinucleotide.Calc_frequencies(self.seq,2)
		return
	...
	def global_relative_abundance(self):
		...
		"""
		self.global_di_abundance = dinucleotide.calc_DN_relative_abund(self.global_nuc_freqs,self.global_di_freqs)
		return
	...
	def calculate_local_freqs(self):
		...
		for i in range(0,len(self.seq) - self.window_size + 1,self.skip):
			...
			window_nuc_freqs, window_di_freqs = dinucleotide.Calc_frequencies(window_seq,2)

			window_relative_abund = dinucleotide.calc_DN_relative_abund(window_nuc_freqs, window_di_freqs)
...
def main():
	...
	# simulated = dinucleotide("simulated.fna")
	# simulated.calculate_local_freqs()
	# #bacteria1.plot_deltas()
	# #
	# dinucleotide.plot_genomes(bacteria1,simulated)
	pass
